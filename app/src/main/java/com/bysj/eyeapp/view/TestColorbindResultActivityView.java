...
public class TestColorbindResultActivityView extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_test_colorbind_result_view);
