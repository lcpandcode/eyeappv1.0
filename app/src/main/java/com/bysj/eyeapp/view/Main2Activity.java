...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCustomSwipeRefreshLayout = (CustomSwipeRefreshLayout) findViewById(R.id.srl);
        ...
        // 设置下拉进度的背景颜色，默认就是白色的
        mCustomSwipeRefreshLayout.setProgressBackgroundColorSchemeResource(android.R.color.white);
        // 设置下拉进度的主题颜色
        mCustomSwipeRefreshLayout.setColorSchemeResources(R.color.colorAccent,
        ...
        mCustomSwipeRefreshLayout.setItemCount(20);

        // 手动调用,通知系统去测量
        mCustomSwipeRefreshLayout.measure(0, 0);
    ...
    private void loadMoreData() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(Main2Activity.this, "加载了" + 20 + "条数据", Toast.LENGTH_SHORT).show();
    ...
    private void initData() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(Main2Activity.this, "刷新了20条数据", Toast.LENGTH_SHORT).show();
